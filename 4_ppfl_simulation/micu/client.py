...
#%%
data = pd.read_csv('/home/wonseok/PPFL/4_ppfl_simulation/micu/data/MICU.csv')
feature = data.drop(columns = ['death','연구등록번호'])
feature_all = data[feature_book["common_features"] + feature_book['micu_specific']]
label = data['death']
...
with open('/home/wonseok/PPFL/4_ppfl_simulation/micu/dataset.pkl','wb') as f:
